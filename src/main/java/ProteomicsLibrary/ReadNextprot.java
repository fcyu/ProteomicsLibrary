...
public class ReadNextprot {
    ...
    public ReadNextprot(String peffPath) throws Exception {
        ...
        for (String id : proteinAnnotationMap.keySet()) {
            ...
            if (!locationVariantMap.isEmpty() || !locationPsiModMap.isEmpty()) {
                ...
                idEntryMap.put(id, new Entry(id, proteinSequenceMap.get(id), locationVariantMap, locationPsiModMap));
            }
        }
    }
    ...
    public class Entry {
        ...
        public Entry(String id, String sequence, Multimap<Integer, Character> locationVariantMap, Multimap<Integer, String> locationModMap) {
            this.id = id;
